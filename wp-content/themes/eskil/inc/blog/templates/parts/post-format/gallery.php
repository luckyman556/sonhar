...
if ( ! empty( $gallery_meta ) ) { ?>
	<div class="qodef-e-media-gallery qodef-swiper-container">
		...
		<div class="swiper-button-prev"><?php eskil_render_svg_icon( 'slider-arrow-left' ); ?></div>
		<div class="swiper-button-next"><?php eskil_render_svg_icon( 'slider-arrow-right' ); ?></div>
	</div>
<?php } else {
