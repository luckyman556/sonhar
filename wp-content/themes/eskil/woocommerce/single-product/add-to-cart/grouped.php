...
<div class="grouped-product-card">
		...
		<?php 
			...
			foreach ($grouped_products as $grouped_product_child) {
				...
				if ($is_cloth) {
					$clothCounter += 1;
					?>
					<button data-cloth-number="<?php  echo $clothCounter;?>" class="step-one-btn <?php if ($clothCounter === 1) {echo 'pressed-btn';} ?>">Grupa #<?php echo $clothCounter; ?> +<?php echo $product->get_price() ? $product->get_price() : '0';?> zł</button>
				<?php }
			?>
	...
	<div class="modal hidden">
		...
		<img class="modal-img" src="" alt="Full view">
...
<script>
	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		prevBtn.addEventListener("click", function(e) {
			...
			currentIndex = (currentIndex - 1 + fabricBlocks.length) % fabricBlocks.length;
