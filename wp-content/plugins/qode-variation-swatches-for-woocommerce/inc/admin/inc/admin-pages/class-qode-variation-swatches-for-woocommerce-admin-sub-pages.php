...
abstract class Qode_Variation_Swatches_For_WooCommerce_Admin_Sub_Pages {
	private $base;
	private $menu_name;
	private $title;
	private $position;
	...
	public function get_content() {
		qode_variation_swatches_for_woocommerce_framework_template_part( QODE_VARIATION_SWATCHES_FOR_WOOCOMMERCE_ADMIN_PATH . '/inc/admin-pages', 'sub-pages/' . $this->get_base(), 'templates/' . $this->get_base(), '', $this->get_atts() );
	}
}
