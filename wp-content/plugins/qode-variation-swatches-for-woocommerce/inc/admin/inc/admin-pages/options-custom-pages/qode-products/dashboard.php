...
if ( ! function_exists( 'qode_variation_swatches_for_woocommerce_premium_add_qode_products_custom_options_page' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function qode_variation_swatches_for_woocommerce_premium_add_qode_products_custom_options_page() {
		$custom_page = Qode_Variation_Swatches_For_WooCommerce_Admin_Options_Custom_Page_Handler::get_instance();

		$custom_page->add_page(
			array(
				'slug'     => 'qode-products',
				'title'    => esc_html__( 'Qode Products', 'qode-variation-swatches-for-woocommerce' ),
				'position' => 1,
				'script'   => false,
	...
	add_action( 'init', 'qode_variation_swatches_for_woocommerce_premium_add_qode_products_custom_options_page', 9 );
}
