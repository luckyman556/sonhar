...
abstract class Qode_Variation_Swatches_For_WooCommerce_Framework_Section implements Qode_Variation_Swatches_For_WooCommerce_Framework_Tree_Interface, Qode_Variation_Swatches_For_WooCommerce_Framework_Child_Interface {
	private $scope;
	private $type;
	private $name;
	private $layout;
	...
	public function add_repeater_element( $params ) {
		if ( isset( $params['name'] ) && ! empty( $params['name'] ) ) {
			$field = new Qode_Variation_Swatches_For_WooCommerce_Framework_Field_Repeater( $params );
	...
	public function render() {
		...
		qode_variation_swatches_for_woocommerce_framework_template_part( QODE_VARIATION_SWATCHES_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/section', $this->get_layout(), $params );
	}
}
