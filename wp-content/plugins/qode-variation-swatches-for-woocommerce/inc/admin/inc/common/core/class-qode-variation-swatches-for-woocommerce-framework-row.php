...
abstract class Qode_Variation_Swatches_For_WooCommerce_Framework_Row implements Qode_Variation_Swatches_For_WooCommerce_Framework_Tree_Interface, Qode_Variation_Swatches_For_WooCommerce_Framework_Child_Interface {
	...
	public function render() {
		...
		qode_variation_swatches_for_woocommerce_framework_template_part( QODE_VARIATION_SWATCHES_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/row', $this->layout, $params );
	}
}
