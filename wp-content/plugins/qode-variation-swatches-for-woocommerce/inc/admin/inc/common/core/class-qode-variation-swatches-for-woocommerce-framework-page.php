...
abstract class Qode_Variation_Swatches_For_WooCommerce_Framework_Page implements Qode_Variation_Swatches_For_WooCommerce_Framework_Tree_Interface {
	private $scope;
	private $type;
	private $slug;
	private $layout;
	...
	public function render() {
		...
		$params['class']      .= ' qodef-page-v4-variation-swatches';

		if ( $this->get_layout() === 'tabbed' ) {
			wp_enqueue_script( 'jquery-ui-tabs' );
		}

		qode_variation_swatches_for_woocommerce_framework_template_part( QODE_VARIATION_SWATCHES_FOR_WOOCOMMERCE_ADMIN_PATH, 'inc/common', 'templates/page', $this->get_layout(), $params );
	}
}
