...
class Qode_Variation_Swatches_For_WooCommerce_Framework_Field_WP_Radio extends Qode_Variation_Swatches_For_WooCommerce_Framework_Field_WP_Type {
				...
				foreach ( $this->options as $key => $value ) {
					...
					<label class="qodef-inline">
						...
						<?php if ( $use_images ) { ?>
							...
							?>
							" src="<?php echo esc_url( $value['image'] ); ?>" alt="<?php echo esc_attr( $key . 'image' ); ?>"/>
						<?php } ?>
					</label>
				<?php } ?>
			</div>
