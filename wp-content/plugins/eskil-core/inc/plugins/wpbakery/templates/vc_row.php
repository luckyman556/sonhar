...
$eskil_core_before_wrapper_open  = apply_filters( 'eskil_core_filter_vc_row_before_wrapper_open', '', $atts );
$eskil_core_after_wrapper_open   = apply_filters( 'eskil_core_filter_vc_row_after_wrapper_open', '', $atts );
$eskil_core_before_wrapper_close = apply_filters( 'eskil_core_filter_vc_row_before_wrapper_close', '', $atts );
$eskil_core_after_wrapper_close  = apply_filters( 'eskil_core_filter_vc_row_after_wrapper_close', '', $atts );
