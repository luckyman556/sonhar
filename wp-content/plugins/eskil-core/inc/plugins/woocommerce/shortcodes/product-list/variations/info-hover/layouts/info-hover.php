<div <?php wc_product_class( $item_classes ); ?><?php qode_framework_inline_style( $this_shortcode->get_item_styles( $params ) ); ?>>
	<div class="qodef-e-inner">
		...
		<div class="qodef-woo-product-content">
			...
			<?php eskil_core_template_part( 'plugins/woocommerce/shortcodes/product-list', 'templates/post-info/variations', '', $params ); ?>
			<?php
