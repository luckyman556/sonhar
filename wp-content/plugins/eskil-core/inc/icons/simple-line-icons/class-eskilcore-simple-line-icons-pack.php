...
if ( ! function_exists( 'eskil_core_add_simple_line_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function eskil_core_add_simple_line_icons_to_collection( $icons ) {
		$icons[] = 'EskilCore_Simple_Line_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'eskil_core_add_simple_line_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EskilCore_Simple_Line_Icons_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'eskil_core_filter_simple_line_specific_icons',
				array(
