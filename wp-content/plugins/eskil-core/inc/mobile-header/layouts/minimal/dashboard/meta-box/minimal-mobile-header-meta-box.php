...
if ( ! function_exists( 'eskil_core_add_page_minimal_mobile_header_meta_box' ) ) {
	/**
	 * Function that add general meta box options for this module
	 *
	 * @param object $page
	 */
	function eskil_core_add_page_minimal_mobile_header_meta_box( $page ) {
	...
	add_action( 'eskil_core_action_after_page_mobile_header_meta_map', 'eskil_core_add_page_minimal_mobile_header_meta_box' );
}
