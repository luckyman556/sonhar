...
if ( ! class_exists( 'EskilCore_Shortcodes' ) ) {
	class EskilCore_Shortcodes {
		...
		function init() {
			...
			include_once ESKIL_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once ESKIL_CORE_SHORTCODES_PATH . '/class-eskilcore-shortcode.php';
			include_once ESKIL_CORE_SHORTCODES_PATH . '/class-eskilcore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'eskil_core_filter_register_shortcodes', $shortcodes = array() );
	...
	EskilCore_Shortcodes::get_instance();
}
