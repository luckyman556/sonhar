...
if ( ! function_exists( 'eskil_core_add_custom_font_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function eskil_core_add_custom_font_shortcode( $shortcodes ) {
		$shortcodes[] = 'EskilCore_Custom_Font_Shortcode';

		return $shortcodes;
	}

	add_filter( 'eskil_core_filter_register_shortcodes', 'eskil_core_add_custom_font_shortcode' );
}

if ( class_exists( 'EskilCore_Shortcode' ) ) {
	class EskilCore_Custom_Font_Shortcode extends EskilCore_Shortcode {

		public function __construct() {
			$this->set_layouts( apply_filters( 'eskil_core_filter_custom_font_layouts', array() ) );

			parent::__construct();
		}

		public function map_shortcode() {
			$this->set_shortcode_path( ESKIL_CORE_SHORTCODES_URL_PATH . '/custom-font' );
			$this->set_base( 'eskil_core_custom_font' );
			$this->set_name( esc_html__( 'Custom Font', 'eskil-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays custom font with provided parameters', 'eskil-core' ) );
			...
			$this->set_option(
				array(
					'field_type'    => 'textarea',
					'name'          => 'title',
					'title'         => esc_html__( 'Title Text', 'eskil-core' ),
					'default_value' => esc_html__( 'Custom Title Text', 'eskil-core' ),
				)
			);
			$this->set_option(
				array(
			...
			$this->set_option(
				array(
					...
					'name'        => 'font_size_1440',
					'title'       => esc_html__( 'Font Size', 'eskil-core' ),
					'description' => esc_html__( 'Set responsive style value for screen size 1440', 'eskil-core' ),
					'group'       => esc_html__( 'Screen Size 1440 Style', 'eskil-core' ),
				)
			);
			$this->set_option(
				array(
			...
			$this->set_option(
				array(
					...
					'name'        => 'font_size_1366',
					'title'       => esc_html__( 'Font Size', 'eskil-core' ),
					'description' => esc_html__( 'Set responsive style value for screen size 1366', 'eskil-core' ),
					'group'       => esc_html__( 'Screen Size 1366 Style', 'eskil-core' ),
				)
			);
			$this->set_option(
				array(
			...
			$this->set_option(
				array(
					...
					'name'        => 'font_size_1024',
					'title'       => esc_html__( 'Font Size', 'eskil-core' ),
					'description' => esc_html__( 'Set responsive style value for screen size 1024', 'eskil-core' ),
					'group'       => esc_html__( 'Screen Size 1024 Style', 'eskil-core' ),
				)
			);
			$this->set_option(
				array(
			...
			$this->set_option(
				array(
					...
					'name'        => 'font_size_768',
					'title'       => esc_html__( 'Font Size', 'eskil-core' ),
					'description' => esc_html__( 'Set responsive style value for screen size 768', 'eskil-core' ),
					'group'       => esc_html__( 'Screen Size 768 Style', 'eskil-core' ),
				)
			);
			$this->set_option(
				array(
			...
			$this->set_option(
				array(
					...
					'name'        => 'font_size_680',
					'title'       => esc_html__( 'Font Size', 'eskil-core' ),
					'description' => esc_html__( 'Set responsive style value for screen size 680', 'eskil-core' ),
					'group'       => esc_html__( 'Screen Size 680 Style', 'eskil-core' ),
				)
			);
			$this->set_option(
				array(
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'eskil_core_custom_font', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return eskil_core_get_template_part( 'shortcodes/custom-font', 'variations/' . $atts['layout'] . '/templates/custom-font', '', $atts );
		}
