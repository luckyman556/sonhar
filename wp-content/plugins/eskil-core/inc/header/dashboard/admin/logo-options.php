...
if ( ! function_exists( 'eskil_core_add_logo_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function eskil_core_add_logo_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'logo',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Logo', 'eskil-core' ),
				'description' => esc_html__( 'Global Logo Options', 'eskil-core' ),
				'layout'      => 'tabbed',
			)
		);
		...
		if ( $page ) {
			...
			$header_tab = $page->add_tab_element(
				array(
					...
					'description' => esc_html__( 'Set options for initial headers', 'eskil-core' ),
				)
			);
			...
			do_action( 'eskil_core_action_after_header_logo_image_section_options_map', $page, $header_tab, $logo_image_section );
			...
			do_action( 'eskil_core_action_before_header_logo_svg_path_section_options_map', $page, $header_tab, $logo_svg_path_section );
			...
			// Hook to include additional options after section part
			do_action( 'eskil_core_action_after_header_logo_svg_path_section_options_map', $page, $header_tab, $logo_svg_path_section );
			...
			// Hook to include additional options before section part
			do_action( 'eskil_core_action_before_header_logo_textual_section_options_map', $page, $header_tab, $logo_textual_section );
			...
			// Hook to include additional options after section part
			do_action( 'eskil_core_action_after_header_logo_textual_section_options_map', $page, $header_tab, $logo_textual_section );

			// Hook to include additional options after module options
			do_action( 'eskil_core_action_after_header_logo_options_map', $page, $header_tab );
		}
	}

	add_action( 'eskil_core_action_default_options_init', 'eskil_core_add_logo_options', eskil_core_get_admin_options_map_position( 'logo' ) );
}
