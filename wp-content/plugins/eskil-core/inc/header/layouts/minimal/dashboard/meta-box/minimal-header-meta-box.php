...
if ( ! function_exists( 'eskil_core_add_minimal_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function eskil_core_add_minimal_header_meta( $page ) {
	...
	add_action( 'eskil_core_action_after_page_header_meta_map', 'eskil_core_add_minimal_header_meta' );
}
