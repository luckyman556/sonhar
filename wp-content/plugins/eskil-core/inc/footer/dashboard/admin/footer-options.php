...
if ( ! function_exists( 'eskil_core_add_page_footer_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function eskil_core_add_page_footer_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'footer',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Footer', 'eskil-core' ),
				'description' => esc_html__( 'Global Footer Options', 'eskil-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$top_footer_area_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Top Footer Area Columns', 'eskil-core' ),
					'description'   => esc_html__( 'Choose number of columns for top footer area', 'eskil-core' ),
					'options'       => eskil_core_get_select_type_options_pool( 'columns_number', true, array( '5', '6' ) ),
					'default_value' => '4',
				)
			);
			...
			$top_footer_area_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Top Footer Area Grid Gutter', 'eskil-core' ),
					'description' => esc_html__( 'Choose grid gutter size to set space between columns for top footer area', 'eskil-core' ),
			...
			$bottom_footer_area_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Bottom Footer Area Columns', 'eskil-core' ),
					'description'   => esc_html__( 'Choose number of columns for bottom footer area', 'eskil-core' ),
					'options'       => eskil_core_get_select_type_options_pool( 'columns_number', true, array( '3', '4', '5', '6' ) ),
					'default_value' => '2',
				)
			);
			...
			$bottom_footer_area_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Bottom Footer Area Grid Gutter', 'eskil-core' ),
					'description' => esc_html__( 'Choose grid gutter size to set space between columns for bottom footer area', 'eskil-core' ),
					'options'     => eskil_core_get_select_type_options_pool( 'items_space' ),
				)
			);
			...
			do_action( 'eskil_core_action_after_page_footer_options_map', $page );
		}
	}

	add_action( 'eskil_core_action_default_options_init', 'eskil_core_add_page_footer_options', eskil_core_get_admin_options_map_position( 'footer' ) );
}
