...
if ( ! class_exists( 'EskilCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class EskilCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'eskil_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return EskilCore_Dashboard_Rest_API
		 */
	...
	EskilCore_Dashboard_Rest_API::get_instance();
}
